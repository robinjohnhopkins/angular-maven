...
== Change from java angular to java angularjs
added app which replaces src/app
thus app/index.html replaces src/index.html

The angularjs app popped in is originally here
